...
def get_searchxj_list(kyw=None, page=1):
    url = 'https://cg.xiaojilicai.com/Home/Product/index.html'
    ...
    names = soup.select('body > div.main-content > div > div > div.title')
    #body > div.main > div:nth-child(3) > div > div:nth-child(3) > p
    #print (names)

    inbuystatus = soup.select('body > div.main-content > div > div > div.right > a')
    #print (inbuystatus)

    inprogresses = soup.find_all(class_=re.compile('text'))
    #body > div.main-content > div > div:nth-child(1) > div.left > table > tbody > tr.line1 > td.td5 > div
    #body > div.main-content > div > div:nth-child(2) > div.left > table > tbody > tr.line1 > td.td5 > div
    ...
    #interests = soup.select("body > div.main-content > div > div > div.left > table > tbody > tr.line1 > td.td1.profit")
    interests = soup.find_all(class_=re.compile('td1 profit'))
    #body > div.main > div > div > div > div.fl > ul > li > p > span
    #print (interests)

    #rangedays = soup.select('body > div.main-content > div > div > div.left > table > tbody > tr.line1 > td.td2')
    rangedays = soup.find_all(class_=re.compile('td2'))
    #print len(rangedays)
    ...
    #for name, inprogress, interest, rangeday in zip(names, inprogresses, interests, rangedays):
        ...
        ##test mode
        #data = [name, inbuystat, u"进度"+inprogress , interest+u"%", rangeday+u"天", '\t']
        ...
        if inbuystat != u"回款中":
            ...
            data = [name, inbuystat, u"进度 "+inprogress, interest+u" %", rangeday+u" 天", delta, '\t']
